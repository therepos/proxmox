...
# wget --no-cache -qO- https://raw.githubusercontent.com/therepos/proxmox/main/install-portainer.sh | bash
# curl -fsSL https://raw.githubusercontent.com/therepos/proxmox/main/install-portainer.sh | bash
