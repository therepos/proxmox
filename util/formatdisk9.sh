...
if [[ -n "$old_pool_name" ]]; then
    echo -e "${GREEN}${RESET} Disk is part of ZFS pool $old_pool_name. Exporting the pool..."
    ...
    echo -e "${GREEN}${RESET} Removing existing ZFS pool $old_pool_name from Proxmox configuration..."
