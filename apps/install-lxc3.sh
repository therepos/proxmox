...
# Enter the container to disable the root password and ensure no login password
echo "Entering the container to disable root password and ensure passwordless login..."
