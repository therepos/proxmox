...
if docker ps -a --format "{{.Names}}" | grep -q "^$CONTAINER_NAME$"; then
    ...
    if [[ "$UNINSTALL" == "y" || "$UNINSTALL" == "Y" ]]; then
        echo "Stopping and removing existing MeTube container, images, volumes, and associated files..."
        ...
        # Remove associated images, volumes, and networks
        ...
        # Remove config, data, and download directories
