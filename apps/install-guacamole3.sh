...
# pct exec "$CTID" -- sudo -u admin bash -c "sudo wget https://raw.githubusercontent.com/itiligent/Guacamole-Install/main/1-setup.sh && sudo chmod +x 1-setup.sh && sudo ./1-setup.sh"
