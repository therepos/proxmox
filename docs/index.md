...
- SSD 1TB zfs (root) + 4TB ext4 (storage). Maximum SSD: SSD 2.5" SATA 7.68TB (1x) + SSD M.2 NVME 4TB (2x). 
- NVIDIA RTX A2000 12GB. (NVIDIA RTX 4000 SFF Ada Generation 20GB GDDR6, NVIDIA RTX 2000 Ada Generation 16GB GDDR6).
